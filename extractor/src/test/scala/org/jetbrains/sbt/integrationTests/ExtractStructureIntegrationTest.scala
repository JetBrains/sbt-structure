...
class ExtractStructureIntegrationTest extends AnyFreeSpecLike {
  ...
  // These errors are only thrown for Scala 2.13 in sbt 1.10+
  private val ManagedIncompatibleScalaVersionError = "Expected `managed-incompatible-scala / scalaVersion` to be 2.13.18 or later, but found 2.13.16."
  private val UnmanagedIncompatibleScalaVersionError = "Expected `unmanaged-incompatible-scala / scalaVersion` to be 2.13.18 or later, but found 2.13.16"
  ...
  "extracted structure should equal to expected structure" - {
    ...
    "1.10" - {
      ...
      "unmanaged-incompatible-scala" in { testProjectShouldFailWith("unmanaged-incompatible-scala", SbtVersion_1_10, ResolveSourcesAndSbtClassifiers, UnmanagedIncompatibleScalaVersionError) }
      "managed-incompatible-scala" in { testProjectShouldFailWith("managed-incompatible-scala", SbtVersion_1_10, ResolveSourcesAndSbtClassifiers, ManagedIncompatibleScalaVersionError) }
    }
    "1.11" - {
      ...
      "unmanaged-incompatible-scala" in { testProjectShouldFailWith("unmanaged-incompatible-scala", SbtVersion_1_11, ResolveSourcesAndSbtClassifiers, UnmanagedIncompatibleScalaVersionError) }
      "managed-incompatible-scala" in { testProjectShouldFailWith("managed-incompatible-scala", SbtVersion_1_11, ResolveSourcesAndSbtClassifiers, ManagedIncompatibleScalaVersionError) }
    }
    "1.12" - {
