...
object StructureKeys {
  ...
  @transient val extractBuild: TaskKey[BuildData] = TaskKey("ssExtractBuild", description = "", rank = Invisible)
  @transient val extractBuilds: TaskKey[Seq[BuildData]] = TaskKey("ssExtractBuilds", description = "", rank = Invisible)
  @transient val extractDependencies: TaskKey[DependencyData] = TaskKey("ssExtractDependencies", description = "", rank = Invisible)
  @transient val extractProject: TaskKey[ProjectData] = TaskKey("ssExtractProject", description = "", rank = Invisible)
  @transient val extractProjects: TaskKey[Seq[ProjectData]] = TaskKey("ssExtractProjects", description = "", rank = Invisible)
  @transient val extractRepository: TaskKey[Option[RepositoryData]] = TaskKey("ssExtractRepository", description = "", rank = Invisible)
  @transient val extractStructure: TaskKey[StructureData] = TaskKey("extractStructure", description = "", rank = Invisible)

  @transient val settingData: TaskKey[Seq[SettingData]] = TaskKey("settingData", description = "", rank = Invisible)
  @transient val taskData: TaskKey[Seq[TaskData]] = TaskKey("taskData", description = "", rank = Invisible)
  @transient val commandData: TaskKey[Seq[CommandData]] = TaskKey("commandData", description = "", rank = Invisible)
  @transient val localCachePath: TaskKey[Option[File]] = TaskKey("localCachePath", description = "", rank = Invisible)
  @transient val allKeys: TaskKey[Seq[AttributeKey[_]]] = TaskKey("allKeys", description = "", rank = Invisible)
  ...
  @transient val dumpStructure: TaskKey[Unit] = TaskKey("dumpStructure", "dump project structure to XML readable by IntelliJ", rank = DTask)
