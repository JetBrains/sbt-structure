//
// NOTE: this is copied from sbt 1.1 branch from sbt.SlashSyntax to cross compiler for sbt 1.0
//
...
import sbt.{AttributeKey, ConfigKey, Configuration, Reference, Scope, ScopeAxis, Scoped, Select, This}
